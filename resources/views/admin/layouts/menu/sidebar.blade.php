        ...
        <nav id="sidebar">
            ...
            <div class="left-custom-menu-adp-wrap">
                <ul class="nav navbar-nav left-sidebar-menu-pro">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.category') }}" ><i class="fa big-icon fa-windows"></i> <span class="mini-dn">Category</span> </span></a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.department-report') }}" ><i class="fa big-icon fa-bar-chart"></i> <span class="mini-dn">Department Reports</span> </span></a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.status-report') }}" ><i class="fa big-icon fa-pie-chart"></i> <span class="mini-dn">Status Reports</span> </span></a>
                    </li>
                </ul>
            </div>
        </nav>
